...
class App:
    def __init__(self, master):
        self.master = master
        self.master.title("Independence degree and Overlap degree Calculator")
        ...
        self.independence_thresh_label = tk.Label(master, text="Threshold(nm):")
    ...
    def calculate_independence(self):
        ...
        #self.independence_result_label.config(text=f"Independence: {independence:.2f}%")
    ...
    def calculate_coincidence(self):
        ...
        #self.coincidence_result_label.config(text=f"Coincidence: {coincidence:.2f}%")      
